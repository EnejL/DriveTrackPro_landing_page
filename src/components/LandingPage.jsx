...
const LandingPage = () => {
  ...
  const content = {
    sl: {
      appName: 'DriveTrack Pro',
      tagline: 'Vaša vozila, na dlani!',
      downloadText: 'Prenesite na',
      storeText: 'App Store',
      scrollText: 'Pomaknite se navzdol',
      featuresTitle: 'Zmogljivosti',
      features: [
        {
          title: 'Sledi Vsemu',
          description: 'Od točenja goriva do polnjenja baterije - vodite popolno zgodovino stroškov pogonskih sredstev.'
        },
        {
    ...
    en: {
      appName: 'DriveTrack Pro',
      tagline: 'Your vehicles, at your fingertips!',
      ...
      features: [
        {
          ...
          description: 'From fuel refueling to battery charging - keep a complete history of propulsion costs.'
        },
        {
    ...
    <div className="landing-page">
      ...
      <section className="hero">
        <div className="hero-content">
          <div className="logo-container">
            <div className="app-logo">
              <img src={appLogo} alt="DriveTrack Pro App Logo" />
            </div>
          </div>
          ...
          <h1 className="app-name">{currentContent.appName}</h1>
          <p className="tagline">{currentContent.tagline}</p>
          <a href="https://apps.apple.com/si/app/drivetrack-pro/id6751538691" className="app-store-button" target="_blank">
            <div className="app-store-badge">
              ...
              <div>
                <div className="download-text">{currentContent.downloadText}</div>
                <div className="store-text">{currentContent.storeText}</div>
              </div>
            </div>
          </a>
        </div>
        ...
        <div className="scroll-indicator">
          ...
          <p className="scroll-text">{currentContent.scrollText}</p>
        </div>
      </section>
      ...
      <section className="features">
        <div className="container">
          <h2 className="section-title">{currentContent.featuresTitle}</h2>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-content">
            <p className="copyright">{currentContent.copyright}</p>
            <Link to="/privacy" className="privacy-link">{currentContent.privacyLink}</Link>
          </div>
        </div>
      </footer>
    </div>
